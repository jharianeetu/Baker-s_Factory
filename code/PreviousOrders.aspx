<%@ Page Title="" Language="C#" MasterPageFile="~/UserMaster.master" AutoEventWireup="true" CodeFile="PreviousOrders.aspx.cs" Inherits="PreviousOrders" %>
                ...
                <asp:Panel ID="pnlPreviousOrders" runat="server" ScrollBars="Auto" Height="500px" BorderColor="Black" 
                    ...
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                            ...
                            <asp:CommandField SelectText="Order Details" ShowSelectButton="True" />
                        </Columns>
